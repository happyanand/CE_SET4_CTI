...
public class Base_Class {
	...
	public void SetUpCEUsersix(String ReferenceLogin) throws IOException, InterruptedException {
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && 
				...
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", 
						"");
				if (replaceKeyValue.contains("AWSPPUserNameR")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("AWSPPPasswordR")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
			...
			if (key.contains(ReferenceLogin) && 
					Url.contains("https://truecoverage-qa.benefitalign.com/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", 
						"");
			...
			if (key.contains(ReferenceLogin) && 
				...
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", 
						"");
				if (replaceKeyValue.contains("FIRSTUSER")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("FIRSTPassword")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
		...
		case "CHROME":
        	...
        	options.addArguments("--force-device-scale-factor=0.75"); // Zoom out to 75%
	...
	public void SetUpRegressionForCTI(String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("URL");
		String jenkinsBrowser = System.getProperty("BROWSER");
		if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
		...
		//				String KeyValue = key + ";" + value;
		//				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
		//				if (replaceKeyValue.contains("AWSPPUserName1")) {
		//					UserName = replaceKeyValue;
		//					String[] arrOfUserName = UserName.split(";");
		//					UserName = arrOfUserName[1];
		//				}
		//				if (replaceKeyValue.contains("AWSPPPassword1")) {
		//					Password = replaceKeyValue;
		//					String[] arrOfPassword = Password.split(";");
		//					Password = arrOfPassword[1];
		//				}
		...
		//				String KeyValue = key + ";" + value;
		//				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
		//				if (replaceKeyValue.contains("UATUserName1")) {
		//					UserName = replaceKeyValue;
		//					String[] arrOfUserName = UserName.split(";");
		//					UserName = arrOfUserName[1];
		//				}
		//				if (replaceKeyValue.contains("UATPassword1")) {
		//					Password = replaceKeyValue;
		//					String[] arrOfPassword = Password.split(";");
		//					Password = arrOfPassword[1];
		//				}
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && 
					Url.contains("https://mme.benefitalign.com/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", 
						"");
				if (replaceKeyValue.contains("FIRSTUSER")) {
...
//=======
	...
	public void SetUpRegressionForCTICases(String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("URL");
		String jenkinsBrowser = System.getProperty("BROWSER");
		if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
		...
		} else if (Url.contains("https://ce-uat.benefitalign.com/"))
		{
			ExtentSuccessMessage("Logged in Environment: UAT");
			System.out.println("Logged in Environment: UAT");
		}else if (Url.contains("https://mme.benefitalign.com/mme/")) {
			ExtentSuccessMessage("Logged in Environment: PROD");
			System.out.println("Logged in Environment: PROD");
		} else if (Url.contains("https://ce-qa.benefitalign.com/")) {
			ExtentSuccessMessage("Logged in Environment: QA");
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && 
					Url.contains("https://mme.benefitalign.com/mme/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", 
						"");
				if (replaceKeyValue.contains("FIRSTUSER")) {
	...
	public void SetUpCEUserCallScript(String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("URL");
		String jenkinsBrowser = System.getProperty("BROWSER");
	    if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
	...
	public void SetUpRegressionForCTICase(String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("URL");
		String jenkinsBrowser = System.getProperty("BROWSER");
		if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
	...
	public void SetUpRegressionForCTIConfrence(String ReferenceLogin) throws IOException, InterruptedException {
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://mme.brokerengage.net/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("ThirdUser")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("ThirdPassword")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
	...
	public void SetUpRegressionForCTIPratice(String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("CEURL");
		String jenkinsBrowser = System.getProperty("BROWSER");
		if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
			Browser = jenkinsBrowser;
		}
	...
	public void switchtabwithindex(int tabindex) {
		// Get all window handles
		Set<String> handles = driver.getWindowHandles();

		// Switch to the second tab (assuming it's the second tab opened)
		// Convert handles set to an array
		String[] handlesArray = handles.toArray(new String[handles.size()]);
		System.out.println("Current Tab Size: " + handles.size());
		// Switch to the second tab
		driver.switchTo().window(handlesArray[tabindex]);

		// Example: Print title of the current tab
	...
	public void MouseClick(By element) throws InterruptedException {
		Actions actions = new Actions(driver);
		WebElement elementLocator = driver.findElement(element);
	...
	public void SetUpRegressionCTI(String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("URL");
		String jenkinsBrowser = System.getProperty("BROWSER");
		if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
