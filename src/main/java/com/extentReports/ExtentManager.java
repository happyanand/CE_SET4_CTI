...
//	private static SimpleDateFormat formatter = new SimpleDateFormat("MMddyyyy_HHmmss");
	public static SimpleDateFormat formatter = new SimpleDateFormat("MMddyyyy");

	public static Date date = new Date();
	public static ExtentReports extent;
	public static String reportFileName = "CTI_Regression_Report_" + formatter.format(date) + ".html";
	...
	public static ExtentReports createInstance() {
		...
		extent.setSystemInfo("Author", "Ravikiran");
