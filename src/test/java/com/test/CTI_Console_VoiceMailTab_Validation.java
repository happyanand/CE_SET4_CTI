...
public class CTI_Console_VoiceMailTab_Validation extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTIConsole_VoiceMail(CensusInfo ApplicantInfo)
        ...
        consumerpage.validate_Voicemail_Tab_Console();
