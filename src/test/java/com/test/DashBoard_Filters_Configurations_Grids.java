...
public class DashBoard_Filters_Configurations_Grids extends AllScenarios_EG_TC {
	...
	public void Dashboard_Filter_Configuration(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI Outbound Call Offline Transfer ***************");		  
		consumerpage.login_CE_validations();
		Call_Sequences.dashboard_Filters();
