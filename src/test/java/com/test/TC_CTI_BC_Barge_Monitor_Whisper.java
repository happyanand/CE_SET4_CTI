...
public class TC_CTI_BC_Barge_Monitor_Whisper extends AllScenarios_EG_TC {
	...
	public void CE_TC_CTI_BC_Barge_Monitor_Whisper(CensusInfo ApplicantInfo)
		...
		System.out.println("******* BC_Barge_Whisper_Monitor  ***************");
		consumerpage.login_CE_validations();
		Call_Sequences.Barge_Monitor_Whisper();
