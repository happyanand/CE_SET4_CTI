...
public class TC_CTI_BF_RG_Barge_Monitor_Whisper extends AllScenarios_EG_TC {
	...
	public void BF_Ring_BMW(CensusInfo ApplicantInfo)
		...
		Call_Sequences.BF_Ring_BMW_Validation();
