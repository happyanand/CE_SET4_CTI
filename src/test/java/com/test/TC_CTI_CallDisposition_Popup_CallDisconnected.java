...
public class TC_CTI_CallDisposition_Popup_CallDisconnected extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_CallDisposition_Popup_Disconnected(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI Call_Disconnected Disposition popup***************");		  
		consumerpage.login_CE_validations();
		consumerpage.validate_callDisconnect_Disposition();
