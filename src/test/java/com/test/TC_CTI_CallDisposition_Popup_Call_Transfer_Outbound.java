...
public class TC_CTI_CallDisposition_Popup_Call_Transfer_Outbound extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_CallDisposition_Popup_Call_Transfer_Outbound(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI CallBack Disposition popup***************");		  
		consumerpage.login_CE_validations();
		consumerpage.validate_DispositionPopup_Transfer_Outbound();
