...
public class TC_CTI_CallDisposition_Popup_NotASale extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_CallDisposition_Popup_NotASale(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI Call_NotaSale popup***************");		  
		consumerpage.login_CE_validations();
		consumerpage.validate_notASale_Disposition();
