...
public class TC_CTI_CallScript_Assign_to_Agent extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_CallScript_Assign_to_Agent()
		...
		System.out.println("******* Customer Engage TC_CTI_CallScript_Assignment_to_Agent ***************");		  
		consumerpage.login_CE_validations();
		NonSyncAgentPopupPage.currenturl();
		consumerpage.new_Tab();
		NonSyncAgentPopupPage.Second_User_CallScript();
		consumerpage.TabSwitchToParent();
		NonSyncAgentPopupPage.validate_CallScriptassignment();
