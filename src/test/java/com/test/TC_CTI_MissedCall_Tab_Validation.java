...
public class TC_CTI_MissedCall_Tab_Validation extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_MissedCallTab(CensusInfo ApplicantInfo)
	    ...
	    consumerpage.validate_MissedCallTab();
