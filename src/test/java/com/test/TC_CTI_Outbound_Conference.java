...
public class TC_CTI_Outbound_Conference extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_Outbound_Call(CensusInfo ApplicantInfo)
	    ...
	    consumerpage.validate_Outbound_Confrence();
