...
public class TC_CTI_Recordings_Tab_Validation extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_RecordingTab(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI Recording Tab Validation***************");		  
		consumerpage.login_CE_validations();
	    consumerpage.ValidateRecordingTab(); 
