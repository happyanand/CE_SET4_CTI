...
public class TC_CTI_Voicemail_To_Agent extends AllScenarios_EG_TC {
	...
	public void EG_TC_CTI_Voicemail(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage TC_CTI_Voicemail_To_Agent ***************");		  
		consumerpage.login_CE_validations();
	    consumerpage.validate_Voicemail_Tab();
