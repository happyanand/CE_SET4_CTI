...
public class TC_Inbound_Admin_Call_Log_Transfer_Online_Offline extends AllScenarios_EG_TC {
	...
	public void Inbound_Admin_Call_Log_Status(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI Inbound Call  ***************");		  
		consumerpage.login_CE_validations();
		Call_Sequences.Inbound_Admin_Call_Log_Online();
