...
public class TC_Inbound_Call_Barge_Monitor_Whisper extends AllScenarios_EG_TC {
	...
	public void Inbound_Admin_Call_Barge_Monitor_Whisper(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage CTI Inbound Call barge ***************");		  
		consumerpage.login_CE_validations(); 
		Call_Sequences.Inbound_Barge_Monitor_WHisper(); 
